...
public final class ContextBootstrapInitializer {
  public static void registerServletWebServerFactoryConfiguration_EmbeddedUndertow(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("org.springframework.boot.autoconfigure.web.servlet.ServletWebServerFactoryConfiguration$EmbeddedUndertow", ServletWebServerFactoryConfiguration.EmbeddedUndertow.class)
        .instanceSupplier(ServletWebServerFactoryConfiguration.EmbeddedUndertow::new).register(beanFactory);
  }

  public static void registerEmbeddedUndertow_undertowServletWebServerFactory(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("undertowServletWebServerFactory", UndertowServletWebServerFactory.class).withFactoryMethod(ServletWebServerFactoryConfiguration.EmbeddedUndertow.class, "undertowServletWebServerFactory", ObjectProvider.class, ObjectProvider.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(ServletWebServerFactoryConfiguration.EmbeddedUndertow.class).undertowServletWebServerFactory(attributes.get(0), attributes.get(1)))).register(beanFactory);
  }

  public static void registerEmbeddedUndertow_undertowServletWebServerFactoryCustomizer(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("undertowServletWebServerFactoryCustomizer", UndertowServletWebServerFactoryCustomizer.class).withFactoryMethod(ServletWebServerFactoryConfiguration.EmbeddedUndertow.class, "undertowServletWebServerFactoryCustomizer", ServerProperties.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(ServletWebServerFactoryConfiguration.EmbeddedUndertow.class).undertowServletWebServerFactoryCustomizer(attributes.get(0)))).register(beanFactory);
  }
