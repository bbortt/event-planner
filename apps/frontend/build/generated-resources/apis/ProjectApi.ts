...
import type {
  Project,
  ReadProjects200Response,
} from '../models';
import {
    ProjectFromJSON,
    ProjectToJSON,
    ReadProjects200ResponseFromJSON,
    ReadProjects200ResponseToJSON,
} from '../models';
...
export class ProjectApi extends runtime.BaseAPI {
     ...
     */
    async readProjectByIdRaw(requestParameters: ReadProjectByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Project>> {
        if (requestParameters.projectId === null || requestParameters.projectId === undefined) {
            throw new runtime.RequiredError('projectId','Required parameter requestParameters.projectId was null or undefined when calling readProjectById.');
        }
     ...
     * Receive the project identified by the given `projectId`.
     */
    async readProjectById(requestParameters: ReadProjectByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Project> {
     ...
     */
    async readProjectsRaw(requestParameters: ReadProjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReadProjects200Response>> {
        const queryParameters: any = {};
     ...
     * Receive all projects to which the user has access to.
     */
    async readProjects(requestParameters: ReadProjectsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReadProjects200Response> {
