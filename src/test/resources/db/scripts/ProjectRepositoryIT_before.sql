...
INSERT INTO project(name, start_time, end_time, archived)
VALUES ('ProjectRepositoryIT-project-1', now(), now(), false),
       ('ProjectRepositoryIT-project-2', now(), now(), false),
       ('ProjectRepositoryIT-project-3', now(), now(),  true),
       ('ProjectRepositoryIT-project-4', now(), now(), false);
...
VALUES ('ProjectRepositoryIT-user-1@localhost', true, (select id from project where name = 'ProjectRepositoryIT-project-1'), 'VIEWER',
       ...
       ('ProjectRepositoryIT-user-1@localhost', true, (select id from project where name = 'ProjectRepositoryIT-project-2'), 'VIEWER',
        (select id from jhi_user where login = 'ProjectRepositoryIT-user-1')),
       ('ProjectRepositoryIT-user-1@localhost', true, (select id from project where name = 'ProjectRepositoryIT-project-3'), 'VIEWER',
        (select id from jhi_user where login = 'ProjectRepositoryIT-user-1')),
       ('ProjectRepositoryIT-user-2@localhost', true, (select id from project where name = 'ProjectRepositoryIT-project-4'),
