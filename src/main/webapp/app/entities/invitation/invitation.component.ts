...
export class InvitationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.invitationService
      ...
      .subscribe(
        (res: HttpResponse<IInvitation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IInvitation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
