...
export type projectsLoadAction = { type: 'project:load-list', payload: { isRetry: boolean } };
...
export const projectsLoad = (isRetry: boolean = false): projectsLoadAction => ({ type: 'project:load-list', payload: { isRetry } });
