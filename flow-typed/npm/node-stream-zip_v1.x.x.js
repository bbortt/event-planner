...
declare module 'node-stream-zip' {
  ...
  declare class StreamZip {
    ...
    stream(entry: string | ZipEntry, callback: (err: any | null, stream?: ReadableStream) => void): void;
    ...
    extract(entry: string | ZipEntry | null, outPath: string, callback: (err?: any, res?: number) => void): void;
