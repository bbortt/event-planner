...
declare module 'webpack' {
  ...
  declare type ExternalItem = string | { [k: string]: string | { [k: string]: any, ... } | ArrayOfStringValues | boolean, ... } | RegExp;

  declare type Externals =
    | ((context: string, request: string, callback: (err?: Error, result?: string) => void) => void)
    | ExternalItem
    | Array<((context: string, request: string, callback: (err?: Error, result?: string) => void) => void) | ExternalItem>;
  ...
  declare type WebpackOptions = {
    ...
    infrastructureLogging?: {|
      ...
      debug?: string | RegExp | (string => boolean) | Array<string | RegExp | (string => boolean)>,
    |},
    loader?: { [k: string]: any, ... },
  ...
  declare class EnvironmentPlugin {
    constructor(env: { [string]: mixed, ... } | string[]): $ElementType<$NonMaybeType<$PropertyType<ResolveOptions, 'plugins'>>, number>;
  }

  declare class DefinePlugin {
    constructor({ [string]: string, ... }): $ElementType<$NonMaybeType<$PropertyType<ResolveOptions, 'plugins'>>, number>;
  }
  ...
  declare class IgnorePlugin {
    constructor(
      ...
      | {|
        ...
        |},
      void | RegExp
    ): $ElementType<$NonMaybeType<$PropertyType<ResolveOptions, 'plugins'>>, number>;
  }
  ...
  declare class HotModuleReplacementPlugin {
    constructor(): $ElementType<$NonMaybeType<$PropertyType<ResolveOptions, 'plugins'>>, number>;
  }
