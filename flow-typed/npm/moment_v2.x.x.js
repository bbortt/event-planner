...
declare class moment$Moment {
  ...
  static utc(initDate: moment$MomentOptions | number | Date | Array<number> | moment$Moment | string | null | void): moment$Moment;
  ...
  static relativeTimeThreshold(unit: 'ss' | 's' | 'm' | 'h' | 'd' | 'M', limit: number): void;
}
