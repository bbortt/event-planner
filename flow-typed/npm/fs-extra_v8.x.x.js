...
declare module 'fs-extra' {
  ...
  declare type CopyFilterAsync = (src: string, dest: string) => Promise<boolean>;
  ...
  declare function copy(src: string, dest: string, options?: CopyOptionsAync): Promise<void>;
  declare function copy(src: string, dest: string, callback: (err: Error) => void): void;
  declare function copy(src: string, dest: string, options: CopyOptionsAync, callback: (err: Error) => void): void;
  ...
  declare function outputFile(file: string, data: any, options?: WriteFileOptions | string): Promise<void>;
  ...
  declare function outputFileSync(file: string, data: any, options?: WriteFileOptions | string): void;
  ...
  declare function access(path: string | Buffer, callback: (err: ErrnoError) => void): void;
  declare function access(path: string | Buffer, mode: number, callback: (err: ErrnoError) => void): void;
  ...
  declare function appendFile(file: string | Buffer | number, data: any, callback: (err: ErrnoError) => void): void;
  declare function appendFile(
    file: string | Buffer | number,
    data: any,
    options?: {
  ...
  declare function chmod(path: string | Buffer, mode: string | number, callback: (err: ErrnoError) => void): void;
  ...
  declare function chown(path: string | Buffer, uid: number, gid: number, callback: (err: ErrnoError) => void): void;

  declare function close(fd: number, callback: (err: ErrnoError) => void): void;
  declare function close(fd: number): Promise<void>;

  declare function fchmod(fd: number, mode: string | number, callback: (err: ErrnoError) => void): void;
  ...
  declare function ftruncate(fd: number, callback: (err: ErrnoError) => void): void;
  ...
  declare function futimes(fd: number, atime: Date, mtime: Date, callback: (err: ErrnoError) => void): void;
  ...
  declare function lchown(path: string | Buffer, uid: number, gid: number, callback: (err: ErrnoError) => void): void;
  declare function lchown(path: string | Buffer, uid: number, gid: number): Promise<void>;

  declare function link(srcpath: string | Buffer, dstpath: string | Buffer, callback: (err: ErrnoError) => void): void;
  declare function link(srcpath: string | Buffer, dstpath: string | Buffer): Promise<void>;

  declare function lstat(path: string | Buffer, callback: (err: ErrnoError, stats: Stats) => any): void;
  declare function lstat(path: string | Buffer): Promise<Stats>;

  declare function mkdir(path: string | Buffer, callback: (err: ErrnoError) => void): void;
  declare function mkdir(path: string | Buffer, mode: number | string, callback: (err: ErrnoError) => void): void;
  declare function mkdir(path: string | Buffer): Promise<void>;

  declare function open(path: string | Buffer, flags: string | number, callback: (err: ErrnoError, fd: number) => void): void;
  ...
  declare function read(fd: number, buffer: Buffer, offset: number, length: number, position: number | null): Promise<ReadResult>;

  declare function readFile(file: string | Buffer | number, callback: (err: ErrnoError, data: Buffer) => void): void;
  declare function readFile(file: string | Buffer | number, encoding: string, callback: (err: ErrnoError, data: string) => void): void;
  ...
  declare function readdir(path: string | Buffer, callback: (err: ErrnoError, files: string[]) => void): void;
  declare function readdir(path: string | Buffer): Promise<string[]>;

  declare function readlink(path: string | Buffer, callback: (err: ErrnoError, linkString: string) => any): void;
  declare function readlink(path: string | Buffer): Promise<string>;

  declare function realpath(path: string | Buffer, callback: (err: ErrnoError, resolvedPath: string) => any): void;
  ...
  declare function rmdir(path: string | Buffer, callback: (err: ErrnoError) => void): void;
  declare function rmdir(path: string | Buffer): Promise<void>;

  declare function stat(path: string | Buffer, callback: (err: ErrnoError, stats: Stats) => any): void;
  ...
  declare function symlink(srcpath: string | Buffer, dstpath: string | Buffer, callback: (err: ErrnoError) => void): void;
  declare function symlink(srcpath: string | Buffer, dstpath: string | Buffer, type?: FsSymlinkType): Promise<void>;

  declare function truncate(path: string | Buffer, callback: (err: ErrnoError) => void): void;
  declare function truncate(path: string | Buffer, len: number, callback: (err: ErrnoError) => void): void;
  declare function truncate(path: string | Buffer, len?: number): Promise<void>;

  declare function unlink(path: string | Buffer, callback: (err: ErrnoError) => void): void;
  declare function unlink(path: string | Buffer): Promise<void>;

  declare function utimes(path: string | Buffer, atime: number, mtime: number, callback: (err: ErrnoError) => void): void;
  declare function utimes(path: string | Buffer, atime: Date, mtime: Date, callback: (err: ErrnoError) => void): void;
  ...
  declare function write(fd: number, data: any, callback: (err: ErrnoError, written: number, str: string) => void): void;
  declare function write(fd: number, data: any, offset: number, callback: (err: ErrnoError, written: number, str: string) => void): void;
  declare function write(
    fd: number,
    data: any,
    offset: number,
  ...
  declare function write(fd: number, buffer: Buffer, offset: number, length: number, position?: number | null): Promise<WriteResult>;
  declare function write(fd: number, data: any, offset: number, encoding?: string): Promise<WriteResult>;

  declare function writeFile(file: string | Buffer | number, data: any, callback: (err: ErrnoError) => void): void;
  declare function writeFile(file: string | Buffer | number, data: any, options?: WriteFileOptions | string): Promise<void>;
  ...
  declare function mkdtemp(prefix: string, callback: (err: ErrnoError, folder: string) => void): void;
