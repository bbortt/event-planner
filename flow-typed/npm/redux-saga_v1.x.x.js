// flow-typed signature: a020dfcac8c22405e91f48c6b5e68379
...
declare module 'redux-saga' {
  ...
  declare export var runSaga: {
    ...
    <A, S, R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => Saga<R>>(options: RunSagaOptions<A, S>, saga: Fn, T1, T2, T3, T4): Task<R>,
  ...
  declare export type SagaMiddleware<C: { ... }> = {
    ...
    run: {
      ...
      <R, T1, T2, T3, T4, T5, T6, T7, Fn: (T1, T2, T3, T4, T5, T6, T7) => Saga<R>>(saga: Fn, T1, T2, T3, T4, T5, T6, T7): Task<R>,
  ...
  declare export type ForkEffect<Ctx, Fn: (...args: Array<*>) => *, D: { detached: true, ... } | void, Args: $ReadOnlyArray<*>> = IEffect<
    'FORK',
    $ReadOnly<{|
      context: Ctx,
      fn: Fn,
  ...
  declare export function detach<T1, T2, T3>(effect: ForkEffect<T1, T2, *, T3>): ForkEffect<T1, T2, { detached: true, ... }, T3>;
  ...
  declare export type CancelEffect<T: Task<*> | $ReadOnlyArray<Task<*>> | SELF_CANCELLATION> = IEffect<'CANCEL', T, false>;
...
declare module 'redux-saga/effects' {
  ...
  declare export var call: {
    ...
    <R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5) => R>(Fn, T1, T2, T3, T4, T5): CallEffect<null, Fn, [T1, T2, T3, T4, T5]>,
    ...
    <Ctx, R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(cfn: [Ctx, Fn], T1, T2, T3, T4): CallEffect<Ctx, Fn, [T1, T2, T3, T4]>,
    ...
    <R, FnName: string, T1, T2, Fn: (T1, T2) => R, Ctx: { [FnName]: Fn, ... }>(cfn: [Ctx, FnName], T1, T2): CallEffect<Ctx, Fn, [T1, T2]>,
    ...
    <R, FnName: string, T1, T2, T3, T4, T5, T6, T7, T8, Fn: (T1, T2, T3, T4, T5, T6, T7, T8) => R, Ctx: { [FnName]: Fn, ... }>(
      cfn: [Ctx, FnName],
      T1,
      T2,
      T3,
  ...
  declare export var apply: {
    ...
    <Ctx, R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5) => R>(Ctx, Fn, T1, T2, T3, T4, T5): CallEffect<Ctx, Fn, [T1, T2, T3, T4, T5]>,
    <Ctx, R, T1, T2, T3, T4, T5, T6, Fn: (T1, T2, T3, T4, T5, T6) => R>(
      Ctx,
      Fn,
      T1,
  ...
  declare export var cps: {
    ...
    <R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4, NodeCallback<R>) => void>(Fn, T1, T2, T3, T4): CpsEffect<null, Fn, [T1, T2, T3, T4]>,
    ...
    <Ctx, R, T1, T2, T3, Fn: (T1, T2, T3, NodeCallback<R>) => void>(cfn: [Ctx, Fn], T1, T2, T3): CpsEffect<Ctx, Fn, [T1, T2, T3]>,
  ...
  declare export var fork: {
    ...
    <R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5) => R>(Fn, T1, T2, T3, T4, T5): ForkEffect<null, Fn, void, [T1, T2, T3, T4, T5]>,
    <R, T1, T2, T3, T4, T5, T6, Fn: (T1, T2, T3, T4, T5, T6) => R>(
      Fn,
      T1,
      T2,
    ...
    <Ctx, R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(cfn: [Ctx, Fn], T1, T2, T3, T4): ForkEffect<Ctx, Fn, void, [T1, T2, T3, T4]>,
    <Ctx, R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5) => R>(
      cfn: [Ctx, Fn],
      T1,
      T2,
  ...
  declare export var spawn: {
    ...
    <R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(Fn, T1, T2, T3, T4): ForkEffect<null, Fn, { detached: true, ... }, [T1, T2, T3, T4]>,
    ...
    <Ctx, R, T1, T2, T3, Fn: (T1, T2, T3) => R>(cfn: [Ctx, Fn], T1, T2, T3): ForkEffect<Ctx, Fn, { detached: true, ... }, [T1, T2, T3]>,
    <Ctx, R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(
      cfn: [Ctx, Fn],
      T1,
      T2,
  ...
  declare export var select: {
    ...
    <S, R, T1, T2, T3, T4, T5, Fn: (S, T1, T2, T3, T4, T5) => R>(Fn, T1, T2, T3, T4, T5): SelectEffect<Fn, [T1, T2, T3, T4, T5]>,
  ...
  declare export var takeEvery: {
    ...
    <A, R, P: TakeableChannel<*> | Pattern, T1, T2, Fn: (T1, T2, A) => R>(P, Fn, T1, T2): ForkEffect<null, Fn, void, [P, Fn, T1, T2]>,
    ...
    <A, R, P: TakeableChannel<*> | Pattern, T1, T2, T3, T4, T5, T6, T7, T8, Fn: (T1, T2, T3, T4, T5, T6, T7, T8, A) => R>(
      P,
      Fn,
      T1,
      T2,
  ...
  declare export var throttle: {
    ...
    <MS: number, P: TakeableChannel<*> | Pattern, A, R, T1, Fn: (T1, A) => R>(MS, P, Fn, T1): ForkEffect<null, Fn, void, [MS, P, Fn, T1]>,
    ...
    <MS: number, P: TakeableChannel<*> | Pattern, A, R, T1, T2, T3, T4, T5, T6, T7, Fn: (T1, T2, T3, T4, T5, T6, T7, A) => R>(
      MS,
      P,
      Fn,
      T1,
    ...
    <MS: number, P: TakeableChannel<*> | Pattern, A, R, T1, T2, T3, T4, T5, T6, T7, T8, Fn: (T1, T2, T3, T4, T5, T6, T7, T8, A) => R>(
      MS,
      P,
      Fn,
      T1,
  ...
  declare export var debounce: {
    ...
    <R, MS: number, P: TakeableChannel<*> | Pattern, T1, Fn: T1 => R>(MS, P, Fn, T1): ForkEffect<null, Fn, void, [MS, P, Fn, T1]>,
    ...
    <R, MS: number, P: TakeableChannel<*> | Pattern, T1, T2, T3, T4, T5, T6, T7, T8, Fn: (T1, T2, T3, T4, T5, T6, T7, T8) => R>(
      MS,
      P,
      Fn,
      T1,
  ...
  declare export var retry: {
    ...
    <R, MT: number, D: number, T1, T2, Fn: (T1, T2) => R>(MT, D, Fn, T1, T2): CallEffect<null, Function, [MT, D, Fn, T1, T2]>,
