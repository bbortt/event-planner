...
declare module '@@aria-query' {
  ...
  declare export type ARIALandmarkRole = 'banner' | 'complementary' | 'contentinfo' | 'form' | 'main' | 'navigation' | 'region' | 'search';

  declare export type ARIALiveRegionRole = 'alert' | 'log' | 'marquee' | 'status' | 'timer';
...
declare module '@testing-library/react' {
  ...
  declare type MatcherFunction = (content: string, element: ?Element) => boolean;
  ...
  declare type QueryByBoundAttribute = (text: Matcher, options?: MatcherOptions) => ?IntersectionHTMLElement;

  declare type AllByBoundAttribute = (text: Matcher, options?: MatcherOptions) => Array<IntersectionHTMLElement>;
  ...
  declare type GetByBoundAttribute = (text: Matcher, options?: MatcherOptions) => IntersectionHTMLElement;
  ...
  declare type QueryByText = (text: Matcher, options?: SelectorMatcherOptions) => ?IntersectionHTMLElement;

  declare type AllByText = (text: Matcher, options?: SelectorMatcherOptions) => Array<IntersectionHTMLElement>;
  ...
  declare type GetByText = (text: Matcher, options?: SelectorMatcherOptions) => IntersectionHTMLElement;
  ...
  declare type AllByRole = (role: ByRoleMatcher, options?: ByRoleOptions) => IntersectionHTMLElement[];

  declare type GetByRole = (role: ByRoleMatcher, options?: ByRoleOptions) => IntersectionHTMLElement;

  declare type QueryByRole = (role: ByRoleMatcher, options?: ByRoleOptions) => IntersectionHTMLElement | null;
  ...
  declare type FireEvent<TInit> = (element: UnionHTMLElement, eventProperties?: TInit) => boolean;
  ...
  declare export function render(ui: React$Element<any>, options?: RenderOptionsWithoutCustomQueries): RenderResult<>;
  ...
  declare export function within(element: UnionHTMLElement, queriesToBind?: GetsAndQueries | Array<GetsAndQueries>): GetsAndQueries;
  ...
  declare export function queryByTestId(container: UnionHTMLElement, id: Matcher, options?: MatcherOptions): ?IntersectionHTMLElement;
  declare export function getByTestId(container: UnionHTMLElement, id: Matcher, options?: MatcherOptions): IntersectionHTMLElement;
  declare export function queryByText(container: UnionHTMLElement, text: Matcher, options?: MatcherOptions): ?IntersectionHTMLElement;
  ...
  declare export function queryByLabelText(container: UnionHTMLElement, text: Matcher, options?: MatcherOptions): ?IntersectionHTMLElement;
  declare export function getByLabelText(
    container: UnionHTMLElement,
    text: Matcher,
    options?: { selector?: string, ... } & MatcherOptions
  ): IntersectionHTMLElement;
  declare export function queryByAltText(container: UnionHTMLElement, text: Matcher, options?: MatcherOptions): ?IntersectionHTMLElement;
  declare export function getByAltText(container: UnionHTMLElement, text: Matcher, options?: MatcherOptions): IntersectionHTMLElement;
