...
declare module 'yargs' {
  ...
  declare type ModuleObject = ModuleObjectDesc | ModuleObjectDescribe | ModuleObjectDescription;

  declare type MiddleWareCallback = (argv: Argv, yargsInstance?: Yargs) => void | ((argv: Argv, yargsInstance?: Yargs) => Promise<void>);
  ...
  declare class Yargs {
    ...
    completion(
      ...
      description?:
        | string
        | false
        | ((current: string, argv: Argv, done: (compeltion: Array<string>) => void) => ?(Array<string> | Promise<Array<string>>)),
      fn?: (current: string, argv: Argv, done: (completion: Array<string>) => void) => ?(Array<string> | Promise<Array<string>>)
    ): this;

    config(key?: string, description?: string, parseFn?: (configPath: string) => { [key: string]: mixed, ... }): this;
    config(key: string, parseFn?: (configPath: string) => { [key: string]: mixed, ... }): this;
    ...
    middleware(middlewareCallbacks: Middleware, applyBeforeValidation?: boolean): this;
    ...
    parse(args?: string | Array<string>, parseCallback?: (err: Error, argv: Argv, output?: string) => void): Argv;
    ...
    version(option: string | (() => string), description: string | (() => string), version: string): this;
