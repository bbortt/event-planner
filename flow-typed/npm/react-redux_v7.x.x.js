// flow-typed signature: 2ee5f89058030540aadf50f476922d1e
...
declare module 'react-redux' {
  ...
  // so to say MP >= P.
  declare type Connector<P, OP, MP: P> = <WC: React$ComponentType<P>>(WC) => Class<ConnectedComponentClass<OP, WC>> & WC;
  ...
  declare export function useDispatch<D>(): (<T: { [key: string]: any }>(T) => T) &
  ...
  declare export function useSelector<S, SS>(selector: (state: S) => SS, equalityFn?: (a: SS, b: SS) => boolean): SS;
  ...
  declare type SelectorFactory<Com: React$ComponentType<*>, Dispatch, S: Object, OP: Object, EFO: Object, CP: Object> = (
    dispatch: Dispatch,
