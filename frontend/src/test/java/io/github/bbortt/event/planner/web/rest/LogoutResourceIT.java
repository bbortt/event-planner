...
import static io.github.bbortt.event.planner.web.rest.TestUtil.ID_TOKEN;
import static io.github.bbortt.event.planner.web.rest.TestUtil.authenticationToken;
 ...
 */
@SpringBootTest(classes = {EventPlannerApp.class, TestSecurityConfiguration.class})
