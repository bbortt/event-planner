...
docker build frontend -f frontend/src/main/docker/Dockerfile --no-cache -t bbortt/event-planner-frontend:$version
docker build frontend -f frontend/src/main/docker/Dockerfile-logstash --no-cache -t bbortt/event-planner-frontend-logstash:$version
